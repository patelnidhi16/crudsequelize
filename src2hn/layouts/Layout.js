...
import User from "components/manager/manager";
import Category from "components/category/category";
import Product from "components/product/product";
import ProductRating from "components/product-rating/productRating";
import Exchange from "components/exchange/exchange";
import ProductType from "components/productType/productType";
import Exersise from "components/exersise/exersise";
import Eatwell from "components/eatwell/eatwell";
import ExersiseType from "components/exersiseTypes/exersiseType";
import EatwellType from "components/eatwellType/eatwellType";
    ...
    <>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route path="/exersiseType" element={<ExersiseType />} />
          <Route path="/eatwellType" element={<EatwellType />} />
          <Route path="/ead" element={<Eap />} />
          ...
          <Route path="/product-ratings" element={<ProductRating />} />
